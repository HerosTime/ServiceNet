...
public class ProviderRecordsRepository {
    ...
    public Page<ProviderRecordDTO> findAllWithFilters(UserProfile userProfile,
        ...
        addFilters(queryCriteria, selectRoot, systemAccountJoin, userProfileJoin, userProfile, providerFilterDTO, search);
    ...
    private <T> void addFilters(CriteriaQuery<T> query, Root<Organization> root,
        ...
        UserProfile userProfile, ProviderFilterDTO providerFilterDTO, String search) {
    ...
    private Long getTotal(ProviderFilterDTO providerFilterDTO, UserProfile userProfile, String search) {
        ...
        this.addFilters(countCriteria, selectRoot, systemAccountJoin, userProfileJoin, userProfile, providerFilterDTO, search);
