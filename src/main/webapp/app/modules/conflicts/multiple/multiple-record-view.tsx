          ...
          {baseRecord ? (
            <Col sm="6">
              ...
              <h5>
                ...
                <TextFormat value={baseRecord.lastVerifiedAt} type="date" format={APP_DATE_FORMAT} blankOnInvalid />
              </h5>
              <h5>
            ...
            <Col sm="6">
              <Row>
                <Col>
                  ...
                  <h5>
                    <Translate contentKey="multiRecordView.lastCompleteReview" />
                    <TextFormat value={partnerRecord.lastVerifiedAt} type="date" format={APP_DATE_FORMAT} blankOnInvalid />
                  </h5>
                  <h5>
                    <Translate contentKey="multiRecordView.lastUpdated" />
